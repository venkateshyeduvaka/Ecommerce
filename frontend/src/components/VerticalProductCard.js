    ...
    return (
      <div className="relative px-3 md:px-6 py-1 md:py-3 animate-pulse">
        ...
        <div className=" w-full bg-slate-200 md:flex justify-between items-center px-2 hidden">
          <div className="bg-gray-300 bg-opacity-60 rounded-full p-3 absolute z-10 top-[180px] left-2"></div>
          <div className="bg-gray-300 bg-opacity-60 rounded-full p-3 absolute z-10 top-[180px] right-2"></div>
        </div>
      ...
      {data && (
        <div className="relative px-3 md:px-6 py-1 md:py-3">
          ...
          <div className=" w-full text-gray-700 md:flex justify-between items-center px-2 hidden">
            <button
              className="bg-gray-300 bg-opacity-60 rounded-full p-2 absolute z-10 top-[180px] left-2"
              onClick={leftScroll}
            >
              <FaChevronLeft className="text-md" />
            </button>
            <button
              className="bg-gray-300 bg-opacity-60 rounded-full p-2 absolute z-10 top-[180px] right-2"
              onClick={rightScroll}
            >
          ...
          <ul
            className="flex items-center rounded-lg gap-6 my-3 w-full h-full overflow-y-scroll scrollbar-none relative transition-all"
            ref={scrollElement}
          >
            {data.map((product, i) => {
              return (
